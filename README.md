...
Repositório oficial para o desenvolvimento do Projeto Integrador. Aplicação web voltada para o controle de compras, solicitações de materiais e serviços de manutenção em instituições religiosas.
...
## Como Executar o Projeto Localmente (Ambiente de Testes)

Existem duas maneiras de rodar a aplicação na sua máquina:

### 1. Automático (Recomendado)
Este método configura todo o ambiente necessário sem exigir conhecimento técnico de quem está operando o computador.

1. Dê um duplo clique no arquivo `rodar_app.bat` localizado na raiz do projeto.
2. O script executará o seguinte fluxo de forma automática:
